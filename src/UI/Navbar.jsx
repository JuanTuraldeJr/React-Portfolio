...
const Navbar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  return (
    <nav className='fixed top-0 w-full bg[rgba(10, 10, 10,0.8)] backdrop-blur-lg z-40 px-1 border-b border-white/10 shadow-lg'>
            ...
            <div className="flex justify-between items-center font-mono h-16">
                ...
                <div className='flex md:flex items-center space-x-8'>
                    <div className='hidden md:flex items-center space-x-8'>
                      ...
                      <a href="#project" className='text-gray-300 text-lg hover:text-xl hover:text-white transition-all'>Project</a>
